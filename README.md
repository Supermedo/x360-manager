<div align="center">
  <img src="public/icon.png" width="128" height="128" alt="X360 Manager Logo">
  <h1>X360 Manager</h1>
  <p><strong>The Ultimate Premium Frontend for Xbox 360 Emulation</strong></p>

  [![Version](https://img.shields.io/badge/version-1.6.2-8b5cf6.svg?style=for-the-badge)](https://github.com/Supermedo/x360-manager/releases)
...
Version 1.6.2 fixes **Xenia config corruption**, **game language override**, and **Game Properties** launch settings. See [RELEASE_v1.6.2.md](RELEASE_v1.6.2.md) or [GitHub Releases](https://github.com/Supermedo/x360-manager/releases).

- **Custom app icon** — correct icon in installer, Start Menu, and taskbar  
- **Performance** — smoother library; debounced saves; fixed cover-sync loop  
- **Fullscreen fix** — no longer stuck after game options (Esc / F11 / Windowed)  
- **Data folder:** `%APPDATA%\x360-manager\`

## Previous: v1.6.0

Profiles, persistence, covers, XBLA launch, onboarding, and console mode — [RELEASE_v1.6.0.md](RELEASE_v1.6.0.md).
...
1. **Download**: Grab the latest `X360-Manager-Setup-1.6.2.exe` from the [Releases](https://github.com/Supermedo/x360-manager/releases) page.
